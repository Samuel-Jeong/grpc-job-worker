...
import com.telcoware.job_worker_app_demo.proto.*;
import com.telcoware.job_worker_app_demo.service.job.JobInfoReflectionFactoryService;
...
import com.telcoware.job_worker_app_demo.util.ProcessUtil;
import com.telcoware.job_worker_app_demo.util.TextUtil;
import com.telcoware.job_worker_app_demo.util.WorkerInfoUtil;
...
public class WorkerGrpcServiceImpl extends WorkerServiceGrpc.WorkerServiceImplBase {
    ...
    private static final String JOB_CLASS_PREFIX = "com.telcoware.job_worker_app_demo.job.dto.scenario.";
